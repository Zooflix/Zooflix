...
function StockHistory() {
  ...
  } else if (stockHistoryList === undefined || stockHistoryList.length === 0) {
    return (
      <Wrapper>
        <Title>
                ...
                <History>
                  <span
                    style={{
                      width: "80px",
                      fontWeight: "bold",
                      color: item.stockType === "매도" ? "#310E93" : "#930E0E",
                    }}
                  >
                    {item.stockType}
                  </span>
                  <span style={{ width: "170px", fontWeight: "bold" }}>
                    {item.stockName}
                  </span>
                  <span style={{ width: "50px", fontSize: "12px" }}>
                    {item.stockNum}주
                  </span>
                  <span style={{ width: "100px", fontSize: "10px" }}>
                    {item.stockDate.slice(0, 4)}.{item.stockDate.slice(4, 6)}.
